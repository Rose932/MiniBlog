...
class Post {
    ...
    /**
     * TODO:
     * > Create a function called addComment that takes a parameter comment and adds it to the list of comments in the post
     ...
     * > Use the appropriate JS operator to increment the commentCount by 1
    ...
    /**
     * TODO:
     * > Create a function called like that takes no parameters and increments the likes by 1
     * > Use the appropriate JS operator to increment the likes by 1
     * Reference: https://www.w3schools.com/jsref/jsref_operators.asp
     */
    // YOUR CODE STARTS HERE ( Feel free to add more lines as neede below this line )
    ...
    display(containerElement) {
         ...
         */
        // define the button config function for the like button
        ...
        likeAction.addEventListener('click', ( function(){
                ...
                const likeActionIcon = document.createElement('i');
                likeActionIcon.classList.add('bi',  "m-2", 'bi-hand-thumbs-up');
                const likesCount = document.createTextNode(`${this.likes}`);

                likeAction.appendChild(likeActionIcon);
                likeAction.appendChild(likesCount);
        ...
        const likeActionLink = document.createElement('element');
        likeActionLink.classList.add('like-actiom-link', 'nav-link', 'p-0');
        ...
        dislikeAction.addEventListener('click', ( function(){
            this.dislike()
            dislikeAction.innerHTML = `Disikes ${this.dislikes}`;
            }.bind(this) )
        ...
        const dislikeActionLink = document.createElement('element');
        ...
        dislikeActionIcon.classList.add('bi', 'bi-hands-thumbs-down');
        ...
        shareAction.innerHTML = `Share ${this.shares}`;
        ...
        const shareActionLink = document.createElement('element');
        ...
        const commentActionLink = document.createElement('element');
        ...
        // postDisplay, authorDisplay, hr, postTitle, postContent, postActions
        postDisplayContainer.appendChild(postDisplay);
        postDisplayContainer.appendChild(authorDisplay);
        postDisplayContainer.appendChild( document.createElement("hr") );
        ...
        commentActionLink.appendChild(commentActionCount);
...
window.onload = function(){
    ...
    postSubmit.addEventListener('click', function(){
        ...
        if (postTitleValue && postContentValue && postAuthorValue){
            ...
            // Change the contents of the post submit button.
            // > Use the createElement function to create the send icon that confirms a comment was sent store it in a variable postSent
            // > use classList to add the icon to the class:
            // "bi", "bi-send-check"
            // Use innerHTML to set the content of the button to ""
            // Use AppendChild to appent the postSent icon to the button

            const postSent = document.createElement('i');
            postSent.classList.add('bi', 'bi-send-check');
            
            postSubmit.innerHTML = "";
            postSubmit.removeAttribute("class");
            postSubmit.classList.add("btn", "btn-success");
            postSubmit.appendChild(postSent);

            post.display(postContainer);
        } else {
            // Change the contents of the post submit button.
            // > Use the createElement function to create the send icon that confirms a comment was sent store it in a variable postFailed
            // > use classList to add the icon to the class:
            // "bi", "bi-send-exclamation"
            // Use innerHTML to set the content of the button to ""
            // Use AppendChild to appent the postFailed icon to the button
            
            const postFailed = document.createElement('i');
            postFailed.classList.add('bi', 'bi-send-exclamation');

            postSubmit.innerHTML = "";
            postSubmit.removeAttribute("class");
            postSubmit.classList.add("btn", "btn-danger");
            postSubmit.appendChild(postFailed);
        ...
        // Use setTimout to retore the default icon
        // https://developer.mozilla.org/en-US/docs/Web/API/setTimeout
        setTimeout(
            () => {
                postSubmit.innerHTML = "";
                const defaultIcon = document.createElement("i");
                defaultIcon.classList.add("bi", "bi-send");

                postSubmit.removeAttribute("class");
                postSubmit.classList.add("btn", "btn-primary");
                postSubmit.appendChild(defaultIcon);
            }, 10000
        )
    });
